...
import org.activityinfo.theme.client.BreadcrumbBar;
...
public class DatabasePage implements IsWidget {
    ...
    public void updateView(Observable<DatabaseViewModel> viewModel) {
        if(viewModel.isLoaded()) {
            ...
            breadcrumbs.clear();
            breadcrumbs.addLink(I18N.CONSTANTS.databases(), PlaceLinks.toUri(new DatabaseListPlace()));
            breadcrumbs.addMenu(Icon.DATABASE, viewModel.get().getLabel(), databaseMenu);
