...
public class TableSliderViewModelTest {
    ...
    public void subform()  {
        ...
        Observable<Maybe<TableSliderViewModel>> viewModel = TableSliderViewModel.compute(setup.getFormStore(), TableModelStore.STORE, tablePlace);
        ...
        assertThat(sliderViewModel.getSlideIndex(), equalTo(1));
