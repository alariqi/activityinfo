...
//    @Test
//    public void test() {
//        StatefulValue<TableAnalysisModel> tableModel =
...
//
//        StatefulValue<TableAnalysisModel> tableModel = new StatefulValue<>(ImmutableTableModel.builder()
//                .formId(setup.getSurveyForm().getFormId())
//                .build());
//
//        TableViewModel viewModel = new TableViewModel(setup.getFormStore(), tableModel);
...
//
//        TableAnalysisModel tableModel = ImmutableTableModel.builder()
//                .formId(setup.getSurveyForm().getFormId())
//                .build();
//
...
//
//        StatefulValue<TableAnalysisModel> tableModel = new StatefulValue<>(
...
//        Connection<TableAnalysisModel> exportModelConnection = setup.connect(exportModel.transform(ExportViewModel::getTableModel));
...
//        IncidentForm incidentForm = setup.getCatalog().getIncidentForm();
//
//        TableAnalysisModel tableModel = ImmutableTableModel.builder().formId(incidentForm.getFormId())
//                .addColumns(ImmutableTableColumn.builder()
//                        .label("My PCODE")
//                        .formula(IncidentForm.PROTECTION_CODE_FIELD_ID.asString())
//                        .build())
...
//
//        Connection<TableAnalysisModel> exportModel = setup.connect(
...
//
//
//        TableAnalysisModel tableModel = ImmutableTableModel.builder().formId(localiteForm.getFormId()).build();
//        TableViewModel viewModel = new TableViewModel(setup.getFormStore(), Observable.just(tableModel));
//
