 ...
 */
@Value.Immutable
public abstract class TableAnalysisModel implements AnalysisModel  {
    ...
    public static TableAnalysisModel fromJson(JsonValue object) {
        ImmutableTableAnalysisModel.Builder model = ImmutableTableAnalysisModel.builder();
